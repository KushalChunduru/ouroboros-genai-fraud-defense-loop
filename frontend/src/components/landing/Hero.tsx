    ...
    <section className="max-w-6xl mx-auto px-6 pt-16 pb-20 md:pt-24 md:pb-28">
      <div className="flex flex-col items-center text-center gap-6">
        ...
        <p className="text-base md:text-lg max-w-2xl" style={{ color: "var(--muted)" }}>
          ...
          scale, and defends against it with a fused detector — then runs the whole system as a self-play arms race
          so the defense&apos;s own blind spots become tomorrow&apos;s attack hypotheses.
        </p>
